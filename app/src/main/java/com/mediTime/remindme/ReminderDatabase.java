...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    public List<Reminder> getMorningReminders(){
        List<Reminder> reminderList = new ArrayList<>();
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                if((time.charAt(0) <= '9' && time.charAt(0) >= '5'   )
                        || (time.charAt(0)== '1'&& time.charAt(1)=='0')
                        ||(time.charAt(0)== '1' && time.charAt(1)== '1'))
                {
                    reminder.setID(Integer.parseInt(cursor.getString(0)));
                    reminder.setTitle(cursor.getString(1));
                    reminder.setDate(cursor.getString(2));
    ...
    public List<Reminder> getNoonReminders(){
        List<Reminder> reminderList = new ArrayList<>();
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                if(time.charAt(0)=='1' &&(time.charAt(1)>='2' && time.charAt(1)<='7'))
                {
                    reminder.setID(Integer.parseInt(cursor.getString(0)));
                    reminder.setTitle(cursor.getString(1));
                    reminder.setDate(cursor.getString(2));
    ...
    public List<Reminder> getNightReminders(){
        List<Reminder> reminderList = new ArrayList<>();
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                if((time.charAt(0)=='1' && (time.charAt(1)>='7'&&time.charAt(1)<='9'))
                        ||(time.charAt(0)=='2')
                        || (time.charAt(0) >= '0' && time.charAt(0)<='4' ))
                {
                    reminder.setID(Integer.parseInt(cursor.getString(0)));
                    reminder.setTitle(cursor.getString(1));
                    reminder.setDate(cursor.getString(2));
