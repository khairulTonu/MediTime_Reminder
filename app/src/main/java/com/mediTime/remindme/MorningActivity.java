...
public class MorningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Reminder> mTest = rb.getMorningReminders();
        ...
        mAddReminderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), ManageReminderAddActivity.class);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = MorningActivity.this;
        ...
        public List<ReminderItem> generateData(int count) {
            ...
            List<Reminder> reminders = rb.getMorningReminders();
